...
function getCommand() {
    ...
    return new commander.Command("merge-sites")
...
async function handler(options) {
    ...
    // let thingiverseResult = await util.readJsonFile("test/merge-sites", "thingiverse-list.json");
    // let cults3dResult = await util.readJsonFile("test/merge-sites", "cults3d-list.json");
    // let printableResult = await util.readJsonFile("test/merge-sites", "printable-list.json");
